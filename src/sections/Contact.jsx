...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "jayryannaret6@gmail.com",
        href: "mailto:jayryannaret6@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
...
export const Contact = () => {
    ...
    <section id ="contact" className="py-32 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-highlight/5 rounded-full bluw-3xl"/>
        </div>
