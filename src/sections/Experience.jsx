        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-3xl mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">
                    Experience shaped by<span className="font-serif italic font-normal text-white"> 
                        {" "}
                        real systems, real problems, and real solutions.
                        </span>
                </h2>
                <p className="text-muted-foreground animate-fade-in animation-delay-200">
                    A timeline of my growth as a developer, from designing user-focused interfaces to building and supporting real-world systems that improve efficiency, usability, and operational workflows.
                </p>
            </div>
              {/* Timeline */}
